...
export function OrderForm() {
  ...
  if (!isConnected) {
    return (
      <div className="card p-8 flex flex-col items-center justify-center min-h-[240px] gap-4">
        ...
        <div className="text-center">
          ...
          <p className="text-[10px] font-mono text-[var(--text-muted)]">Argent X or Braavos // Starknet Sepolia</p>
        </div>
      </div>
    );
  }
